...
const ModalContact = ({ closeModal, name }) => {
  ...
  const submit = (e) => {
    e.preventDefault()
    console.log(`Votre prénom : ${prenom}, votre nom : ${nom}, votre email : ${mail}, votre message: ${message}`);
  };
  return (
    <>
      ...
      <div
        ...
        className="fixed z-10 top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 rounded p-10 bg-[#DB8876] w-[40%] h-[90%] overflow-auto"
      >
        ...
        <form action="" className="flex flex-col gap-2" onSubmit={submit}>
          <label id="label-prenom" className="text-xl 2xl:text-3xl text-[#312E2E]" htmlFor="prenom">
            Prénom
          </label>
          <input
            id="prenom"
          ...
          <label id="label-nom" className="text-xl 2xl:text-3xl text-[#312E2E]" htmlFor="nom">
            Nom
          </label>
          <input
            id="nom"
          ...
          <label id="label-mail" className="text-xl 2xl:text-3xl text-[#312E2E]" htmlFor="mail">
            Email
          </label>
          <input
            id="mail"
          ...
          <label id="label-message" className="text-xl 2xl:text-3xl text-[#312E2E]" htmlFor="message">
            Votre message
          </label>
          <textarea
            value={message}
